        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '信息公开名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.xinxiName" placeholder="信息公开名称" clearable></el-input>
                     </el-form-item>
                 
                     <el-form-item :label="contents.inputTitle == 1 ? '信息公开类型' : ''">
                        <el-select v-model="searchForm.xinxiTypes" placeholder="请选择信息公开类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in xinxiTypesSelectSearch"
                               v-bind:key="index"
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhaoshengxuanchuan/upload/xinxiMuBan.xls"
                        >批量导入信息公开数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xinxi','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="xinxiPhoto"
                                     header-align="center"
                                     width="200"
                                     label="信息公开图片">
                        <template slot-scope="scope">
                            <div v-if="scope.row.xinxiPhoto">
                                <img :src="$base.url+scope.row.xinxiPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.xinxiTypes!= '' && this.searchForm.xinxiTypes!= undefined) {
                    params['xinxiTypes'] = this.searchForm.xinxiTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=xinxi_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.xinxiTypesSelectSearch = data.data.list;
                    }
                });
            },
            //每页数
