    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">招生宣传管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <el-form-item label="招生人员姓名" class="input" v-if="tableName=='zhaoshengrenyuan'">
                            <el-input v-model="ruleForm.zhaoshengrenyuanName" autocomplete="off" placeholder="招生人员姓名"  />
                        </el-form-item>
                        <el-form-item label="招生人员手机号" class="input" v-if="tableName=='zhaoshengrenyuan'">
                            <el-input v-model="ruleForm.zhaoshengrenyuanPhone" autocomplete="off" placeholder="招生人员手机号"  />
                        </el-form-item>
                        <el-form-item label="招生人员身份证号" class="input" v-if="tableName=='zhaoshengrenyuan'">
                            <el-input v-model="ruleForm.zhaoshengrenyuanIdNumber" autocomplete="off" placeholder="招生人员身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="zhaoshengrenyuanPhotoFlag">
                            </el-form-item>
                            <el-form-item label="招生人员头像" class="input" v-if="tableName=='zhaoshengrenyuan'">
                                    <file-upload
                                        tip="点击上传招生人员头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="招生人员邮箱" class="input" v-if="tableName=='zhaoshengrenyuan'">
                            <el-input v-model="ruleForm.zhaoshengrenyuanEmail" autocomplete="off" placeholder="招生人员邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='zhaoshengrenyuan'">
                                <el-input v-model="ruleForm.createTime" autocomplete="off" placeholder="创建时间"  />
                           </el-form-item>
                        -->
    ...
    export default {
        data() {
            return {
                ...
                zhaoshengrenyuanPhotoFlag:false,//用于刷新文件上传
            };
        },
        mounted(){
        ...
        methods: {
            ...
            zhaoshengrenyuanPhotoUploadChange(fileUrls) {
               this.ruleForm.zhaoshengrenyuanPhoto = fileUrls;
                if(this.zhaoshengrenyuanPhotoFlag){
                    this.zhaoshengrenyuanPhotoFlag=false;
                }else{
                    this.zhaoshengrenyuanPhotoFlag=true;
                }
            },
            close(){
            ...
            login() {
                            ...
                            //     return
                            // }
                            if((!this.ruleForm.zhaoshengrenyuanName)&& 'zhaoshengrenyuan'==this.tableName){
                                this.$message.error('招生人员姓名不能为空');
                                return
                            }
                             if('zhaoshengrenyuan' == this.tableName && this.ruleForm.zhaoshengrenyuanPhone&&(!this.$validate.isMobile(this.ruleForm.zhaoshengrenyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.zhaoshengrenyuanIdNumber)&& 'zhaoshengrenyuan'==this.tableName){
                                this.$message.error('招生人员身份证号不能为空');
                                return
                            }
                            // zhaoshengrenyuan 中的 招生人员头像 判空处理
                            // if('zhaoshengrenyuan' == this.tableName && (this.ruleForm.zhaoshengrenyuanPhoto== null ||this.ruleForm.zhaoshengrenyuanPhoto== "")){
                            //     this.$message.error("招生人员头像不能为空");
                            //     return
                            // }
                            if('zhaoshengrenyuan' == this.tableName && this.ruleForm.zhaoshengrenyuanEmail&&(!this.$validate.isEmail(this.ruleForm.zhaoshengrenyuanEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // zhaoshengrenyuan 中的 创建时间 判空处理
                            // if('zhaoshengrenyuan' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            //     this.$message.error("创建时间不能为空");
                            //     return
                            // }
                this.$http({
