...
//            return R.error(511,"永远不会进入");
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        zhengceService.deleteBatchIds(Arrays.asList(ids));
...
//                            zhengceEntity.setZhengceName(data.get(0));                    //政策名称 要改的
//                            zhengceEntity.setZhengcePhoto("");//详情和图片
//                            zhengceEntity.setZhengceTypes(Integer.valueOf(data.get(0)));   //政策类型 要改的
