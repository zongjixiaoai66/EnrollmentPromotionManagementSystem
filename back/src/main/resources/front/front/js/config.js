...
var indexNav = [
    ...
    {
        name: '校训校徽',
        url: './pages/singleSeach/detail.html?id=4'
    },
    {
        name: '公告',
    ...
    {
        name: '招生计划',
        url: './pages/jihua/list.html'
    },
    {
        name: '信息公开',
        url: './pages/xinxi/list.html'
    },
    {
        name: '招生政策',
        url: './pages/zhengce/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/zhaoshengxuanchuan/admin/dist/index.html#/login";
